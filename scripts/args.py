...
def parse_args():
    ...
    parser.add_argument('--use_causal', action='store_true', help='Whether to use causal learning')
    parser.add_argument('--causal_weight', type=float, default=0.1, help='Weight for causal loss')
    ...
    # avatar
    parser.add_argument("--emb_model", type=str, default="openai/clip-vit-large-patch14")
    ...
    # path
    parser.add_argument('--root_dir', default='/root/onethingai-tmp/avatar/data')
